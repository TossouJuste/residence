...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="{{ route('dashboard') }}">
        <div class="logo" style="margin: 70px 0px 50px 50px;">
            <img alt="Logo" src="{{ image('logos/logo-cousac.jpeg') }}" class="h-80px app-sidebar-logo-default" />
        </div>
        <img alt="Logo" src="{{ image('logos/logo-cousac.jpeg') }}" class="h-20px app-sidebar-logo-minimize" />
    </a>
