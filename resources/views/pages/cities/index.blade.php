                        ...
                        @foreach($cities as $city)
                            <tr>
                                ...
                                <td>
                                    <!-- Dropdown -->
                                    <div class="dropdown">
                                        <button class="btn btn-light btn-active-light-success btn-flex btn-center btn-sm" type="button" id="dropdownMenuButton{{ $city->id }}" data-bs-toggle="dropdown" aria-expanded="false">
                                            Actions
                                        </button>
